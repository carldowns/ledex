...
public class Cmd2 {
    ...
    public Cmd2(CmdState2 initialState) {
    ...
    public Cmd2() {
        this.type = this.getClass().getSimpleName();
        this.state = CmdState2.started;
    }

    public Cmd2(String ID) {
        this();
        setID(ID);
    }

    public Cmd2(String ID, String parentID) {
        this();
        setID(ID);
     ...
     * @return
     */
    public CmdState2 getState() {
        return state;
    }

    @JsonIgnore
    public boolean isCompleted() {
        return state == CmdState2.completed;
    }

    @JsonIgnore
    public boolean isFailed() {
        return state == CmdState2.failed;
    }

    @JsonIgnore
    public boolean isStarted() {
        return state == CmdState2.started;
    }

    @JsonIgnore
    public boolean isWaiting() {
        return state == CmdState2.waiting;
    }
     ...
     * @param state
     */
    public void setState(CmdState2 state) {
        this.state = state;
    }

    public void showCompleted() {
        state = CmdState2.completed;
    }

    public void showFailed() {
        state = CmdState2.failed;
    }
    ...
    public void checkNotNull (Object ref, String msg) {
        ...
        showFailed(msg);
        throw new CmdRuntimeException2(msg);
    }
