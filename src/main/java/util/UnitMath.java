...
//    }
     ...
     * unit type is preserved
     */
    public static String multiplyBigDecimal(String unit, BigDecimal multiplier, int scale) {
...
//    }
    ...
    public static String multiplyUnits(String unit1, String unit2) {
        return multiplyUnits (new UnitConverter(unit1), new UnitConverter(unit2));
    }

    /**
     * unit1 return type is preserved
     */
    public static String multiplyUnits(UnitConverter uc1, UnitConverter uc2) {

        UnitConverter.UnitTypeValue utv1 = uc1.getUnitTypeValue(true);
        UnitConverter.UnitTypeValue utv2 = uc2.getUnitTypeValue(true);

        BigDecimal result = utv1.toDecimal().multiply(utv2.toDecimal());
        UnitConverter.UnitTypeValue output = new UnitConverter.UnitTypeValue(uc1.getUnitType(), result.toString());
        return output.toTypeValueString();
    }
